...
<head>
    <title>M Faiza Fachra Azizi : 5026231126</title>
    <meta charset="utf-8">
...
<body>
    <div class="jumbotron text-center mx-auto">
        <h1>5026231126 : M Faiza Fachra Azizi</h1>
    </div>
    ...
    <nav class="navbar navbar-expand-sm bg-light">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/speda">Tugas CRUD</a>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                <a class="nav-link" href="/karyawan2">Latihan 2</a>
            </li>
            <li class="nav-item">
